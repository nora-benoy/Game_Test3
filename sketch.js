...
B1 = createSprite(displayWidth-1210,displayHeight-530,5,425);
B2 = createSprite(displayWidth-750,displayHeight-700,1125,5);
B3 = createSprite(displayWidth-255,displayHeight-300,5,715);
...
B7 = createSprite(displayWidth-720,displayHeight-565,5,175);
B8 = createSprite(displayWidth-425,displayHeight-555,225,5);
B9 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B10 = createSprite(displayWidth-1210,displayHeight-335,5,125);

B11 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B12 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B13 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B14 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B15= createSprite(displayWidth-1210,displayHeight-335,5,125);
B16 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B17 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B18 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B19 = createSprite(displayWidth-1210,displayHeight-335,5,125);
B20 = createSprite(displayWidth-1210,displayHeight-335,5,125);
